...
from .client_registry import ClientRegistry, create_client
from .exceptions import InvalidRequestError, ModelNotFoundError, ValidationError
...
class LLMRequestManager:
    ...
    @asynccontextmanager
    async def with_client(self, provider: str, model: str | None = None):
        """客户端上下文管理器
