    ...
    def _load_config(self) -> QwenOmniConfig:
        ...
        try:
            config_data = {
                ...
                "model_name": self._get_config_wrapper("qwen_omni.model_name", "qwen-omni-turbo"),
                "voice_character": self._get_config_wrapper("qwen_omni.voice_character", "Chelsie"),
                "media_format": self._get_config_wrapper("qwen_omni.media_format", "wav"),
                "base_url": self._get_config_wrapper("qwen_omni.base_url", "https://dashscope.aliyuncs.com/compatible-mode/v1"),
            }
